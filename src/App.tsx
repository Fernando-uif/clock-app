        ...
        bg-cover`,
          {
            ...
            "md:bg-[url('/src/assets/background/morning-tablet.jpg')]":
              isMorging,
            "md:bg-[url('/src/assets/background/night-tablet.jpg')]":
              !isMorging,
            "xl:bg-[url('/src/assets/background/morning-desktop.jpg')]":
              isMorging,
            "xl:bg-[url('/src/assets/background/night-desktop.jpg')]":
              !isMorging,
          }
        )}
      >
